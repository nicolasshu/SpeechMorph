...
unzip cmu_us_bdl_arctic-0.95-release.zip
unzip cmu_us_clb_arctic-0.95-release.zip
unzip cmu_us_jmk_arctic-0.95-release.zip
unzip cmu_us_ksp_arctic-0.95-release.zip
unzip cmu_us_rms_arctic-0.95-release.zip
unzip cmu_us_slt_arctic-0.95-release.zip

mv cmu_us_awb_arctic awb
mv cmu_us_bdl_arctic bdl
mv cmu_us_clb_arctic clb
mv cmu_us_jmk_arctic jmk
mv cmu_us_ksp_arctic ksp
mv cmu_us_rms_arctic rms
mv cmu_us_slt_arctic slt
